...
def clean_twitter_optimized(text):
    """
    Limpieza optimizada conservando información emocional de tweets
    
    Args:
        text (str): Texto original del tweet
        
    Returns:
        str: Texto limpio conservando emociones
    """
...
def preprocess_data(df):
    ...
    print("🔧 Aplicando limpieza optimizada a los textos...")
