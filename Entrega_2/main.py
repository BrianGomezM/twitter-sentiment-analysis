...
def main():
    ...
    print("   ✅ Dropout optimizado (0.4 input, 0.2 recurrente)")
    print("   ✅ Learning Rate con warmup (comienza en 0.001)")
    print("   ✅ Gradient Clipping (clipnorm=1.0)")
    print("   ✅ Regularización L2 mejorada (0.001)")
    print("   ✅ Early Stopping con paciencia de 12 épocas")
    print("   ✅ Batch Normalization en cada capa importante")
    print("   ✅ Métricas avanzadas: F1-Score, Precision, Recall por clase")
